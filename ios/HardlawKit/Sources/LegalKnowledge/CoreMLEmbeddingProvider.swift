...
///
/// The compiled `BGE-small-zh.mlmodelc` and its `vocab.txt` are generated by
/// `scripts/convert_bge_to_coreml.py` (see `docs/embedding-provider-plan.md`)
...
public final class CoreMLEmbeddingProvider: EmbeddingProvider, @unchecked Sendable {
    ...
    private func loadIfNeeded() throws -> (model: MLModel, vocab: [String: Int]) {
        ...
        if !loadAttempted {
            ...
            // `scripts/convert_bge_to_coreml.py` emits bge-small-zh-v1.5;
            // accept the BGE-small-zh spelling too.
