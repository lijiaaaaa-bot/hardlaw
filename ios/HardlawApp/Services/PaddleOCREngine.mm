...
- (instancetype)initWithDetModel:(NSString*)dp recModel:(NSString*)rp dictPath:(NSString*)dict {
    ...
    NSString* dictText=[NSString stringWithContentsOfFile:dict encoding:NSUTF8StringEncoding error:nil];
    NSMutableArray* a=[NSMutableArray arrayWithObject:@" "];[a addObjectsFromArray:[dictText componentsSeparatedByString:@"\n"]];
